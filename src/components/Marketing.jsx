...
function Marketing() {
  ...
  if (uploadStatus.uploaded) {
    ...
    return (
      <div className='w-[50%] h-[100%] max1078:w-[90vw] fade-in-up'>
      ...
      <div className='w-[60%] max1078:w-[90vw]'>
        <section className='py-12 mt-[10rem] max1078:mt-0 fade-in-up'>
          <div className="container mx-auto px-4">
            <h2 className="text-[4.5vw] font-semibold text-gray-800 mb-4 rainbow-text-animation max767:text-[10vw] max767:text-center fade-in">
